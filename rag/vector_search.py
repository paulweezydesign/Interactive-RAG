...
def recall(
        ...
        try:
            ...
            if unique:
                # ⚡ Bolt Optimization: Offload uniqueness filtering to the database.
                # This reduces data transfer and client-side processing by ensuring
                # we only get unique sources directly from the MongoDB aggregation pipeline.
                pipeline.extend([
                    {
                        "$group": {
                            "_id": "$source",
